...
export const strings = {
  it: {
    ...
    invalidConfirm: 'Il link di conferma non è valido o è scaduto. <a href="/">Iscriviti di nuovo</a>.',
  ...
  en: {
    ...
    invalidConfirm: 'The confirmation link is invalid or has expired. <a href="/">Subscribe again</a>.',
